...
class Giohang extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='Website Bán Giày - Giỏ hàng của bạn';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='Website Bán Giày - Thông tin đơn hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $this->email->to($list);
            $this->email->subject('Hệ thống bán Website Bán Giày ');
        ...
        $this->data['title']='Website Bán Giày - Kết quả đơn hàng';
