	...
	<div class="banner-product">
		<div class="container">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<img src="https://x9shop.vn/wp-content/uploads/2020/08/banner111-1400x474.jpg" style="height: 330px;width : 1150px">
			</div>
		</div>
	</div>
	<div class="slider">
                                        ...
                                        <div class="product-lt">
                                            <div class="lt-product-group-image">
                                                <a href="<?php echo $sp['alias'] ?>" title="<?php echo $sp['name'] ?>" >
                                                    <img style="width : 180px;height: 180px" class="img-p"src="public/images/products/<?php echo $sp['avatar'] ?>" alt="">
                                                </a>
