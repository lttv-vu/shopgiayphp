					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Tặng phụ kiện (khi phiếu mua hàng trên 800,000 đ)</li>
											</ul>
											<ul>
												<li>Tặng bình xịt khuẩn (Áp dụng đến hết năm 2022) <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
											<ul>
												<li>Giảm thêm 100,000đ khi mua đơn hàng trên 2,000,000đ  <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>Tình trạng</b>
								<br>
								<span>Sản phẩm còn nguyên vẹn. Số hiệu sản xuất, kiểu dáng, nhãn hiệu rõ ràng.</span>
							</div>
							<div style="margin-top: 20px;">
								<b>Bảo hành</b>
								<br>
								<span>Bảo hành 1 năm cho các loại phụ kiện</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
						</div>
					</div>
